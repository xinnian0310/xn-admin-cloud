...
public class NoticeService {
    ...
    public NoticeVO getById(Long id) {
        ...
        if (notice.getPublisherId() != null) {
            publisherName =
                    userRepository
                            .findById(notice.getPublisherId())
                            .map(
                                    u ->
    ...
    private NoticeVO publishInternal(Long id) {
        ...
        List<SysNoticeReceiver> receivers =
                targets.stream()
                        .map(
                                user -> {
        ...
        payload.put(
                "publishedAt",
                notice.getPublishedAt() != null ? notice.getPublishedAt().toString() : null);
    ...
    public List<NoticeReaderVO> readers(Long id) {
        ...
        Map<Long, User> users =
                userRepository
                        .findAllById(readers.stream().map(SysNoticeReceiver::getUserId).toList())
                        .stream()
    ...
    public List<MyNoticeVO> myList() {
        ...
        Map<Long, String> publisherNames = loadPublisherNames(notices.values().stream().toList());
    ...
    public void markRead(Long id) {
        ...
        SysNoticeReceiver receiver =
                receiverRepository
                        .findByNoticeIdAndUserId(id, user.getId())
