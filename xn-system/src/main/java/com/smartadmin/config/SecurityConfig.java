...
public class SecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> {
                    auth                        .requestMatchers("/api/auth/login").permitAll()
                        ...
                        .requestMatchers("/api/auth/captcha", "/api/auth/captcha/**").permitAll()
                            .requestMatchers("/api/login-page-configs/active").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        boolean wildcard = origins.isEmpty()
                || origins.stream().anyMatch(o -> "*".equals(o));
        ...
        if (wildcard) {
            ...
            if (prod) {
                throw new IllegalStateException("生产环境禁止 CORS 使用 *，请配置 app.security.cors.allowed-origins 白名单");
            }
